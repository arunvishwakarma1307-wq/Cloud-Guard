...
A Flutter-based cloud security and file-management MVP focused on honest account-security information, local PDF validation, a temporary local file workspace, App Lock PIN protection, theme settings, and functional browser notifications.
...
Firebase Storage, a Storage bucket, billing setup, and Storage rules are not required for the current authentication, PDF-validation, local-workspace, account-security, and browser-notification features.

...
class _AppLockPageState extends State<AppLockPage> {
  ...
  Future<void> _unlockWithBiometric() async {
    ...
    try {
      ...
      setState(() {
        _errorMessage =
            'Biometric authentication was not completed. You can use your PIN instead.';
      });
      ...
      setState(() {
        if (error.code == LocalAuthExceptionCode.biometricLockout ||
          ...
          _errorMessage =
              'Biometric authentication was not completed. Use your PIN instead.';
        }
      });
    } catch (_) {
      if (!mounted) return;
  ...
  Future<void> _unlock() async {
    ...
    if (!mounted || _remainingLockout > Duration.zero) {
      return;
    }
    ...
    try {
      ...
      showDialog<void>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text(
            'A secure Firebase sign-in link was sent to $email. '
            'Open it in this same browser, then set a new App Lock PIN.',
          ),
          actions: [
            TextButton(
      ...
      setState(() {
        _errorMessage =
            'Could not send recovery link. Please try again.';
      });
    }
  }
